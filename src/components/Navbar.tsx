...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-900 text-white shadow-lg border-b border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4 font-[Minecraft]">
            ...
            <Link to="/categories/java" className="px-3 py-2 rounded-md font-medium hover:bg-gray-700">Articles</Link>
      ...
      {isOpen && (
        <div className="md:hidden font-[Minecraft]">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">Home</Link>
            <Link to="/categories/java" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">Articles</Link>
